...
## Test endpoint with the docker

- `GET '/'`: This is a simple health check, which returns the response 'Healthy'.
  ![get](images/docker_get.png)
- `POST '/auth'`: This takes a email and password as json arguments and returns a JWT based on a custom secret.
  ![auth](images/docker_auth.png)
- `GET '/contents'`: This requires a valid JWT, and returns the un-encrpyted contents of that token.
  ![contents](images/docker_contents.png)

### Check CodePipeline Deployment

![codepipeline_build](images/pipeline.png)

### Test Endpoint with ELB url

![get](images/elb_get.png)
![contents](images/elb_contents.png)
